...
export default function LoginPage() {
  ...
  const handleGoogle = async () => {
    ...
    try {
      ...
      const { token, user } = await api.post('/auth/firebase', { idToken });
      ...
      <div className="w-full max-w-md">
        ...
        <div className="card space-y-4">
          ...
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 bg-white text-gray-900 hover:bg-gray-100 font-medium py-2.5 px-4 rounded-lg transition-colors disabled:opacity-60 disabled:cursor-not-allowed"
          >
          ...
          <button onClick={handleDemo} disabled={loading} className="btn-secondary w-full py-2.5 disabled:opacity-60">
